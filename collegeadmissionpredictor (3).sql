...
INSERT INTO `branch` (`b_id`, `st_id`, `b_name`, `active`) VALUES
(9, 2, 'Information Technology', 1),
(10, 2, 'Computer Science', 1),
(11, 1, 'Information Technology', 1),
(12, 1, 'EXTC', 1),
(13, 2, 'Electronics and Computer Science', 1),
(14, 2, 'Artificial Intelligence', 1),
(15, 2, 'Machine Learning', 1),
(16, 1, 'Electronics and Computer Science', 1);
...
INSERT INTO `cutoff` (`c_id`, `inst_id`, `st_id`, `b_id`, `cutoff`) VALUES
(4, 2, 2, 9, '90'),
(5, 1, 1, 11, '75'),
(6, 1, 2, 9, '85'),
(7, 1, 2, 10, '91'),
...
CREATE TABLE `faculty` (
  ...
  `inst_desc` varchar(255) NOT NULL,
  `inst_img` text NOT NULL,
  `inst_phone` double NOT NULL,
...
INSERT INTO `faculty` (`fid`, `inst_id`, `fname`, `inst_desc`, `inst_img`, `inst_phone`, `inst_email`, `inst_city`) VALUES
(11, 2, 'Sachin Parmar', 'This is the Best Engg. College', '1635737556_frcrce.jpeg', 9876543211, 'frcrce@gmail.com', '817'),
(12, 1, 'ABC ', 'This is the Best Engg. College', '1635737660_thakur.jpg', 7418529633, 'thakurcollege@gmail.com', '817');
...
CREATE TABLE `institute` (
  `inst_id` int(5) NOT NULL,
  `u_id` int(5) NOT NULL,
  `inst_name` varchar(255) NOT NULL,
  `faculty_flag` int(2) NOT NULL COMMENT '1- Assigned Faculty \r\n0- Not Assigned',
...
INSERT INTO `institute` (`inst_id`, `u_id`, `inst_name`, `faculty_flag`, `active`) VALUES
(1, 1, 'Thakur College', 1, 1),
(2, 1, 'FRCRCE', 1, 1),
(3, 2, 'DY Patil College', 0, 1),
(4, 1, 'LR Tiwari', 0, 1);
...
INSERT INTO `stream` (`st_id`, `st_name`, `active`) VALUES
(1, 'B Tech', 1),
(2, 'B Engg.', 1);
...
CREATE TABLE `student` (
  ...
  `feedbackflag` int(2) NOT NULL COMMENT '0-Feedback not submitted \r\n1- Feedback Submitted',
  `fname` varchar(50) NOT NULL,
...
INSERT INTO `student` (`sid`, `feedbackflag`, `fname`, `lname`, `email`, `phone`, `password`, `feedback`, `TimeStamp`) VALUES
(10, 1, 'Sachin', 'Parmar', 'parmarsachin707@gmail.com', '9082572209', '$2y$10$TdoZQBKMfo5RWXLwwDfBC.CW3KLwTBDIuf2gHr6QsUA0wFMu3lkle', 'ABC', '2021-11-01 05:58:28'),
(11, 0, 'Darshal', 'Parmar', 'crce.9075.ecs@gmail.com', '9004901800', '$2y$10$d9od20O7wZpMdqbBNqqKKOZL7br.QzABcBE00sPlfXh8PfeT9LYWq', '', '2021-11-01 05:18:45');
...
INSERT INTO `university` (`u_id`, `u_name`, `active`) VALUES
(1, 'Mumbai University', 1),
(2, 'Pune University', 1),
(3, 'Delhi University', 1),
(5, 'Jaipur University', 1);
...
--
ALTER TABLE `branch`
  MODIFY `b_id` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `cutoff`
  MODIFY `c_id` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `institute`
  MODIFY `inst_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
